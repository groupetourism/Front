...
import { FaCalendarAlt, FaStar, FaUtensils, FaFlag, FaEllipsisH } from "react-icons/fa"; // Import icons
    ...
    <>
      ...
      <div className="relative w-full h-auto bg-gradient-to-b from-slate-50 to-slate-100">
        ...
        <section className="flex justify-center w-full mt-8 px-4">
          <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-lg p-4 w-full max-w-4xl overflow-x-auto">
                ...
                <li
                  ...
                  className={`flex flex-col items-center justify-center p-2 rounded-lg cursor-pointer transition duration-300 ${
                    activeItem === item.id
                      ...
                      : "bg-white/50 hover:bg-orange-50 text-slate-700"
                  }`}
